  ...
  },
  {
    ...
    sections: [{
      ...
      items: [
        ...
        // { key: 'lingya_qq_publish_creation_process_text', label: '创作过程文本', placeholder: '留空时按素材内容稳定生成' },
  ...
  },
  {
    ...
    sections: [{
      ...
      items: [
        ...
        { key: 'higg_browser_fallback_mode', label: '失败回退模式', placeholder: '留空禁用；本机可填 bitbrowser' },
        ...
        { key: 'higg_chrome_proxy_ports', label: 'Chrome 备用代理端口', placeholder: '未分配任务代理时使用，如 20001,20002' },
