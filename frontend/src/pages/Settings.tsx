  ...
  },
  {
    ...
    sections: [{
      ...
      items: [
        ...
        { key: 'lingya_qq_publish_intro', label: '默认简介', placeholder: '可由内容接口 intro/description 覆盖' },
        { key: 'lingya_qq_publish_prompt', label: '默认分镜提示词', placeholder: '可由内容接口 prompt/highlight_prompt 覆盖' },
        { key: 'lingya_qq_publish_creation_process_text', label: '创作过程文本', placeholder: 'Seedance 2.0 Tool' },
