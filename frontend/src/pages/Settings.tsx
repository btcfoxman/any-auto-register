  ...
  },
  {
    ...
    sections: [{
      ...
      items: [
        ...
        { key: 'lingya_qq_publish_generation_timeout', label: 'Generation Timeout Seconds', placeholder: '600' },
        { key: 'lingya_qq_publish_generation_poll_interval', label: 'Generation Poll Interval Seconds', placeholder: '5' },
      ],
    }],
  },
  {
